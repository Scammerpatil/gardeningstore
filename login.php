...
<body style="font-family: Dosis, sans-serif; background-image: url('img/bg-img/nature.jpg'); background-size: 100%; background-position: center -50px;">
    <?php include "./components/general/Navbar.php" ?>
    <?php include './components/general/Hero.php' ?>
    
    <div class="hero min-h-screen relative z-10 overflow-hidden">
        <form class="w-full max-w-xl bg-base-200 px-10 py-10 rounded-lg shadow-lg my-28 mx-auto"
            ...
            <div class="text-center">
                <span class="text-base-content text-base">Already have an account ?</span> 
                <a href="login.php" class="text-base text-primary">Login</a>
            </div>
        </form>
    </div>
