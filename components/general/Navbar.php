    ...
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden gap-2 lg:flex lg:flex-1 lg:justify-end">
            ...
            <div class="dropdown dropdown-end">
                <div tabindex="0" role="button" class="btn text-lg font-semibold btn btn-success"><i
                        class="fa-solid fa-user"></i>Sign Up <svg width="12px" height="12px"
                        class="inline-block h-2 w-2 fill-current opacity-60" xmlns="http://www.w3.org/2000/svg"
