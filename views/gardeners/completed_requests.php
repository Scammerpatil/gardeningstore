...
$query = "SELECT h.hiring_id, c.name AS customer_name, h.hire_date_from, h.hire_date_to, h.task, h.duration_days, h.total_amount 
          FROM hire h 
...
ob_start();
?>
<h1 class="text-3xl font-bold text-center uppercase">Completed Jobs</h1>
