...
$query = "SELECT h.hiring_id, c.name AS customer_name, h.hire_date_from, h.hire_date_to, h.task, h.duration_days, h.total_amount, h.status 
          FROM hire h 
...
ob_start();
?>
<h1 class="text-3xl font-bold text-center uppercase">Manage Hire Requests</h1>
    ...
    <table class="table-auto w-full border-collapse border border-base-content">
        <thead>
            <tr class="bg-base-200 text-base text-center font-semibold">
                ...
                <th class="border border-base-content p-3">Hire Date From</th>
                <th class="border border-base-content p-3">Hire Date To</th>
                <th class="border border-base-content p-3">Task</th>
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr class="text-center text-base">
                    ...
                    <td class="p-3 border border-base-content"><?= $row['hire_date_from']; ?></td>
                    <td class="p-3 border border-base-content"><?= $row['hire_date_to']; ?></td>
                    <td class="p-3 border border-base-content"><?= $row['task']; ?></td>
